...
import com.integrales_market.domain.Purchase;
import com.integrales_market.domain.PurchaseItem;
import com.integrales_market.persistence.entity.Compra;
...
public class PurchaseMapperImpl implements PurchaseMapper {
    ...
    protected List<PurchaseItem> comprasProductoListToPurchaseItemList(List<ComprasProducto> list) {
        ...
        for ( ComprasProducto comprasProducto : list ) {
            list1.add( purchaseItemMapper.toPurchaseItemItem( comprasProducto ) );
        }
